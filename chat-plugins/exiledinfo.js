...
exports.commands = {
    ...
    opensource: function (target, room, user) {
        ...
        this.sendReplyBox(
            ...
            "Note: We allow anyone to join the organization, seeing as though the reason Exiled exists is due to people practicing/learning code, and having fun ^~^</a><br />" +
            "If you want to see the newest updates/features to the Exiled server, I suggest for you to use /repo and look at the repositority where we update primarily, and host Exiled :P</a>"
        );
    },
