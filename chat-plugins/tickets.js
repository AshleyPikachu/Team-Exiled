...
let rewardcenter = [
  ...
  ['5 Bucks', 'Buys 5 bucks. (PM an admin or leader)', 400],
  ['10 Bucks', 'Buys 10 bucks. (PM an admin or leader)', 850],
  ['PSGO Pack', 'Buys 1 PSGO pack. (PM an admin for the pack)', 750],
  ['3 PSGO Packs', 'Buys 3 PSGO packs. (PM an admin for the packs)', 1500],
  ['Avatar', 'Buys an custom avatar to be applied to your name (You supply. Images larger than 80x80 may not show correctly)', 2000],
  ['Casino Driver', 'Buys Room Driver in Casino. (this can be removed.)', 3000],
  ['Private Room', 'Buys a private room. (Room will be private)', 5000],
...
exports.commands = {
	...
	tickets: function (target, room, user) {
		...
		this.sendReplyBox(Chat.escapeHTML(target) + " has " + amount + currencyName(amount) + ".");
	},
	...
	transferticketshelp: ["/transfertickets [user], [amount] - Transfer a certain amount of tickets to a user."],
